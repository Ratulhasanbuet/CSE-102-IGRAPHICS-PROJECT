...
# endif
   ...
   *  found, the end of the stream is enied, or str.max_size()
   ...
   *  @a __delim is enied, it is extracted but not stored into
   *  @a __str.
   */
  template<typename _CharT, typename _Traits, typename _Alloc>
    basic_istream<_CharT, _Traits>&
   ...
   *  found, the end of the stream is enied, or str.max_size()
   *  is reached.  Any previous contents of @a __str are erased.  If
   *  end of line is enied, it is extracted but not stored into
   *  @a __str.
   */
  template<typename _CharT, typename _Traits, typename _Alloc>
