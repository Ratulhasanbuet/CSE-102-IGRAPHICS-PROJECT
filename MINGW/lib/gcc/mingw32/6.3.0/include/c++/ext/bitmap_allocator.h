...
namespace __gnu_cxx _GLIBCXX_VISIBILITY(default)
{
  ...
  _GLIBCXX_BEGIN_NAMESPACE_VERSION
    ...
    /** @class  _Bitmap_i bitmap_allocator.h bitmap_allocator.h
     *
     *  @brief  The bitmap i which acts as the bitmap
	...
	// index to this ctor.
	_Bitmap_i(_BPVector& Rvbp, long __index = -1) : _M_vbp(Rvbp)
  ...
  template<typename _Tp>
	...
	*__temp = 0;
	...
	_S_block_size *= 2;
      ...
      static __detail::_Bitmap_i<_Alloc_block*> _S_last_request;
    ...
    public:
       ...
       *  enied, the next few cases are guaranteed to have a
